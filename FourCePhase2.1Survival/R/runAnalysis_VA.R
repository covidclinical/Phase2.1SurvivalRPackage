runAnalysis_VA=function(currSiteId, dir.output){
  ...
  tryCatch(runAnalysis_TemporalTrend_VA(currSiteId,  dir.output),error=function(e) print(e))
  cat("Phase1.1 PAPER REVISION\n")
  tryCatch(runAnalysis_R1_VA(currSiteId, dir.output),error=function(e) print(e))
  cat("DONE")
  sink(type = "message")
  sink()
}