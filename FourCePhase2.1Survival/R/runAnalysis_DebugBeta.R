...
runAnalysis_DebugBeta=function(currSiteId, dir.input, dir.output){
...
###standard deviation
junk.original=survfit.coxnet.beta.fun(dat.survival, nm.event=nm.event, nm.lab.keep,nm.cls, siteid, dir.output, myscale="original", is.ind=T, is.stand=F)
junk.original.stand=survfit.coxnet.beta.fun(dat.survival, nm.event=nm.event, nm.lab.keep,nm.cls, siteid, dir.output, myscale="original", is.ind=T, is.stand=T)
junk.log=survfit.coxnet.beta.fun(dat.survival, nm.event=nm.event, nm.lab.keep,nm.cls, siteid, dir.output, myscale="log", is.ind=T, is.stand=F)
junk.log.stand=survfit.coxnet.beta.fun(dat.survival, nm.event=nm.event, nm.lab.keep,nm.cls, siteid, dir.output, myscale="log", is.ind=T, is.stand=T)

cbind(original=junk.original$mybeta, original.stand=junk.original.stand$mybeta,log=junk.log$mybeta, log.stand=junk.log.stand$mybeta)

###
junk.obs=survfit.coxnet.beta.fun(dat.survival, nm.event=nm.event, nm.lab.keep,nm.cls, siteid, dir.output, is.ind=T, my.ind="obs", is.stand=F)
junk.mis=survfit.coxnet.beta.fun(dat.survival, nm.event=nm.event, nm.lab.keep,nm.cls, siteid, dir.output, is.ind=T, my.ind="mis", is.stand=F)
cbind(obs=junk.obs$mybeta,mis=junk.mis$mybeta)

save(
     file=file.path(dir.output, paste0(currSiteId, "_DebugBeta.Result.Rdata")))
}
