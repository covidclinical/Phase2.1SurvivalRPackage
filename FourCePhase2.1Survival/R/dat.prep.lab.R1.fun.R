...
dat.prep.lab.R1.fun=function(dat.survival, nm.event, nm.lab.keep){
  ...
  dat=dat[,c("patient_num", "days_since_admission", nm.event, "calendar_date","calendar_day", nm.lab.keep)]
  dat
  }
