survfit.coxnet.R1.strat.fun=function(dat.survival, nm.event, nm.lab.keep, nm.dem, nm.cls, siteid, dir.output, 
  ...
  patient.female=dat.valid$patient_num[dat.valid$sexfemale==1]
  patient.male=dat.valid$patient_num[dat.valid$sexfemale==0]
  
  patient.age18to25=dat.valid$patient_num[dat.valid$age18to25==1]
  patient.age26to49=dat.valid$patient_num[dat.valid$age26to49==1]
  patient.age50to69=dat.valid$patient_num[dat.valid$age18to25==0&
                                            dat.valid$age26to49==0&
                                            dat.valid$age70to79==0&
                                            dat.valid$age80plus==0]
  patient.age70to79=dat.valid$patient_num[dat.valid$age70to79==1]
  patient.age80plus=dat.valid$patient_num[dat.valid$age80plus==1]
  
  patient.age70plus=unique(c(dat.valid$patient_num[dat.valid$age70to79==1],
                             dat.valid$patient_num[dat.valid$age80plus==1]))
  patient.age70below=setdiff(dat.valid$patient_num, c(patient.age70plus, patient.age18to25))
  
  patient.black=dat.valid$patient_num[dat.valid$raceBlack==1]
  patient.white=dat.valid$patient_num[dat.valid$raceBlack==0&
                                      dat.valid$raceAsian==0&
                                      dat.valid$raceHispanic.and.Other==0]
  
  roc.sep.cov.cv.female=tryCatch(ROC.Survfit.FUN(dat.label=dat.valid[dat.valid$patient_num%in%patient.female,], score=score.sep.cov.cv[score.sep.cov.cv$patient_num%in%patient.female,], t0.all, nm.event, ipw=F, is.sep=T),error=function(e) NA)
  roc.sep.cov.cv.male=tryCatch(ROC.Survfit.FUN(dat.label=dat.valid[dat.valid$patient_num%in%patient.male,], score=score.sep.cov.cv[score.sep.cov.cv$patient_num%in%patient.male,], t0.all, nm.event, ipw=F, is.sep=T),error=function(e) NA)
  
  roc.sep.cov.cv.age26to49=tryCatch(ROC.Survfit.FUN(dat.label=dat.valid[dat.valid$patient_num%in%patient.age26to49,], score=score.sep.cov.cv[score.sep.cov.cv$patient_num%in%patient.age26to49,], t0.all, nm.event, ipw=F, is.sep=T),error=function(e) NA)
  roc.sep.cov.cv.age50to69=tryCatch(ROC.Survfit.FUN(dat.label=dat.valid[dat.valid$patient_num%in%patient.age50to69,], score=score.sep.cov.cv[score.sep.cov.cv$patient_num%in%patient.age50to69,], t0.all, nm.event, ipw=F, is.sep=T),error=function(e) NA)
  roc.sep.cov.cv.age70to79=tryCatch(ROC.Survfit.FUN(dat.label=dat.valid[dat.valid$patient_num%in%patient.age70to79,], score=score.sep.cov.cv[score.sep.cov.cv$patient_num%in%patient.age70to79,], t0.all, nm.event, ipw=F, is.sep=T),error=function(e) NA)
  roc.sep.cov.cv.age80plus=tryCatch(ROC.Survfit.FUN(dat.label=dat.valid[dat.valid$patient_num%in%patient.age80plus,], score=score.sep.cov.cv[score.sep.cov.cv$patient_num%in%patient.age80plus,], t0.all, nm.event, ipw=F, is.sep=T),error=function(e) NA)
  
  roc.sep.cov.cv.50below=tryCatch(ROC.Survfit.FUN(dat.label=dat.valid[dat.valid$patient_num%in%c(patient.age50to69,patient.age70plus)!=1,], score=score.sep.cov.cv[score.sep.cov.cv$patient_num%in%c(patient.age50to69,patient.age70plus)!=1,], t0.all, nm.event, ipw=F, is.sep=T),error=function(e) NA)
  roc.sep.cov.cv.50to69=tryCatch(ROC.Survfit.FUN(dat.label=dat.valid[dat.valid$patient_num%in%patient.age50to69,], score=score.sep.cov.cv[score.sep.cov.cv$patient_num%in%patient.age50to69,], t0.all, nm.event, ipw=F, is.sep=T),error=function(e) NA)
  roc.sep.cov.cv.70plus=tryCatch(ROC.Survfit.FUN(dat.label=dat.valid[dat.valid$patient_num%in%patient.age70plus,], score=score.sep.cov.cv[score.sep.cov.cv$patient_num%in%patient.age70plus,], t0.all, nm.event, ipw=F, is.sep=T),error=function(e) NA)
  
  roc.sep.cov.cv.black=tryCatch(ROC.Survfit.FUN(dat.label=dat.valid[dat.valid$patient_num%in%patient.black,], score=score.sep.cov.cv[score.sep.cov.cv$patient_num%in%patient.black,], t0.all, nm.event, ipw=F, is.sep=T),error=function(e) NA)
  roc.sep.cov.cv.white=tryCatch(ROC.Survfit.FUN(dat.label=dat.valid[dat.valid$patient_num%in%patient.white,], score=score.sep.cov.cv[score.sep.cov.cv$patient_num%in%patient.white,], t0.all, nm.event, ipw=F, is.sep=T),error=function(e) NA)
